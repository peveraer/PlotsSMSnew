...
int main(){
  ...
  TString pp_gluglu("pp #rightarrow #tilde{b}#kern[0.3]{#bar{#tilde{b}}}");
  ...
  models.push_back(model_limits("T2bb", basetitle+"b#kern[0.4]{"+lsp+"}"));
  models.back().add("SUS-16-032, 0-lep sbottom", folder+"T2bb_Batool.root",
                    cSus16007alpha, "combined_obsExclOneTimesProspino_BR100pct", "combined_expExclOneTimesProspino_BR100pct");
  models.back().add("SUS-16-033, 0-lep ("+mht+")", folder+"T2bb_RA2.root", 
   		    cSus15002, "ObsLim", "ExpLim");
  models.back().add("SUS-16-036, 0-lep ("+mt2+")", folder+"T2bb_MT2.root", 
...
// models.back().add("", folder+"T2tt_1l.root", 
 ...
 //		    cComb, "gObs", "gExp");
  ...
  for(size_t imodel(0); imodel < models.size(); imodel++){
    ...
    float Xmin(350), Xmax(1300), Ymin(0), Ymax(900), glu_lsp;
