...
int main(){
  ...
  TString pp_gluglu("pp #rightarrow #tilde{q}#kern[0.3]{#bar{#tilde{q}}}");
  TString basetitle(pp_gluglu+",  #tilde{q} #rightarrow ");
  ...
  models.push_back(model_limits("T2qq", basetitle+"q#kern[0.4]{"+lsp+"}"));
  models.back().add("SUS-16-033, 0-lep ("+mht+")", folder+"T2QQ_RA2.root", 
  		    cSus15002, "ObsLim2", "ExpLim2");
  models.back().add("SUS-16-036, 0-lep ("+mt2+")", folder+"T2QQ_MT2.root", 
 		    cSus15003, "ObsLim_1squark", "ExpLim_1squark");
  //  models.back().add("SUS-16-016, 0-lep ("+aT+"), 12.9 fb^{-1}", folder+"T2QQ_alphaT_v2.root", 
  //		    cSus15004, "observed_total", "expected_total");

  models.back().add("", folder+"T2QQ_RA2.root", 
  		    cSus15002, "ObsLim", "ExpLim");
  models.back().add("", folder+"T2QQ_MT2.root",
                    cSus15003, "ObsLim", "ExpLim");
  //  models.back().add("", folder+"T2QQ_alphaT_degen_v2.root", 
  //		    cSus15004, "observed_total", "expected_total");
...
// models.back().add("", folder+"T2tt_1l.root", 
 ...
 //		    cComb, "gObs", "gExp");
  ...
  for(size_t imodel(0); imodel < models.size(); imodel++){
    ...
    float Xmin(350), Xmax(1800), Ymin(0), Ymax(1200), glu_lsp;
...
void addLabelsTitle(float lMargin, float tMargin, float rMargin, TString title){
  ...
  TLatex label3; label3.SetNDC(); label3.SetTextAlign(31);// label3.SetTextFont(41);                                                                                                                                                         
  label3.SetTextSize(0.6*tMargin);
  label3.SetTextFont(42);
  label3.DrawLatex(1-rMargin-0.04,1-tMargin-0.07,"35.9 fb^{-1} (13 TeV)");
  ...
  //  label.DrawLatex(0.5,0.5,"{#tilde{q}}_{L}+{#tilde{q}}_{R} ({#tilde{u}},{#tilde{d}},{#tilde{s}},{#tilde{c}})");
  label2.DrawLatex(0.22,0.27,"one light #lower[-0.12]{#tilde{q}}");
  label2.DrawLatex(0.36,0.52,"#lower[-0.12]{#tilde{q}}_{L}+#lower[-0.12]{#tilde{q}}_{R} (#lower[-0.12]{#tilde{u}},#lower[-0.12]{#tilde{d}},#lower[-0.12]{#tilde{s}},#lower[-0.12]{#tilde{c}})");
...
TH2D baseHistogram(float Xmin, float Xmax, float Ymin, float Ymax){
  ...
  hbase.GetXaxis()->SetTitle("m#kern[0.12]{_{#lower[-0.12]{#tilde{q}}}} [GeV]");
